...
import (
	...
	versioned "vm-controller/pkg/client/clientset/versioned"
	internalinterfaces "vm-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "vm-controller/pkg/client/listers/cloud/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudV1().VirtualMachines(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudV1().VirtualMachines(namespace).Watch(context.TODO(), options)
			},
		},
		&cloudv1.VirtualMachine{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *virtualMachineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudv1.VirtualMachine{}, f.defaultInformer)
}
