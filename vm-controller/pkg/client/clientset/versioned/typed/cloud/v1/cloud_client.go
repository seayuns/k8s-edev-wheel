...
import (
	v1 "vm-controller/pkg/apis/cloud/v1"
	"vm-controller/pkg/client/clientset/versioned/scheme"
...
// CloudV1Client is used to interact with features provided by the cloud.waibizi.com group.
type CloudV1Client struct {
	restClient rest.Interface
}

func (c *CloudV1Client) VirtualMachines(namespace string) VirtualMachineInterface {
